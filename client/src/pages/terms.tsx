      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-8">
        <div className="prose prose-sm max-w-none dark:prose-invert">
          ...
          <p className="text-sm text-muted-foreground">
            Our AI Product Description Generator analyzes product images and
            creates marketing descriptions using artificial intelligence.
            Results are generated for informational purposes.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            You must provide your own OpenAI and Firecrawl API keys. We are not
            responsible for API costs or usage limits from third-party services.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            liable for any damages arising from use of generated content.
          </p>
